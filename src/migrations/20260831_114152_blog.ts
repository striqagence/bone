...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "_posts_v" (
  	...
  	"version_publie_le" timestamp(3) with time zone,
  	"version_minutes_lecture" numeric,
  ...
  ALTER TABLE "posts" ADD CONSTRAINT "posts_categorie_id_categories_id_fk" FOREIGN KEY ("categorie_id") REFERENCES "public"."categories"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_posts_v" ADD CONSTRAINT "_posts_v_version_categorie_id_categories_id_fk" FOREIGN KEY ("version_categorie_id") REFERENCES "public"."categories"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "posts_categorie_idx" ON "posts" USING btree ("categorie_id");
  ...
  CREATE INDEX "_posts_v_version_version_categorie_idx" ON "_posts_v" USING btree ("version_categorie_id");
