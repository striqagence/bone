...
/** Le lien encadré de la colonne de partage d'un article. */
export function IconeLien() {
  return (
    <span className="inline-flex size-5 shrink-0 items-center justify-center">
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden>
        <g stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          <path d="M12.5 2.5h2.25A2.75 2.75 0 0 1 17.5 5.25V7.5M7.5 17.5H5.25A2.75 2.75 0 0 1 2.5 14.75V12.5" />
          <path d="M8.25 11.75a3 3 0 0 0 4.25 0l2.5-2.5a3 3 0 0 0-4.25-4.25l-.5.5" />
          <path d="M11.75 8.25a3 3 0 0 0-4.25 0l-2.5 2.5a3 3 0 0 0 4.25 4.25l.5-.5" />
        </g>
      </svg>
    </span>
  );
...
/**
 * Marque LinkedIn de la colonne de partage.
 *
 * Le fichier `public/brand/linkedin.svg` est peint en blanc pour le pied de
 * page ; sur le fond clair d'un article il disparaîtrait. Le tracé est donc
 * repris ici en `currentColor`.
 */
export function IconeLinkedin() {
  return (
    <span className="inline-flex size-4 shrink-0 items-center justify-center">
      <svg width="15.697" height="15" viewBox="0 0 15.697 15" fill="none" aria-hidden>
        <path
          d="M0 1.74242C0 1.23736 0.176773 0.820697 0.530303 0.492424C0.883833 0.164136 1.34344 0 1.90909 0C2.46465 0 2.91414 0.161606 3.25758 0.484848C3.61111 0.818182 3.78788 1.25252 3.78788 1.78788C3.78788 2.27273 3.61617 2.67676 3.27273 3C2.9192 3.33333 2.45455 3.5 1.87879 3.5H1.86364C1.30808 3.5 0.858591 3.33333 0.515152 3C0.171712 2.66667 0 2.24747 0 1.74242ZM0.19697 15V4.87879H3.56061V15H0.19697ZM5.42424 15H8.78788V9.34849C8.78788 8.99494 8.82829 8.72221 8.90909 8.5303C9.0505 8.18686 9.26515 7.89645 9.55303 7.65909C9.84091 7.42171 10.202 7.30303 10.6364 7.30303C11.7677 7.30303 12.3333 8.06565 12.3333 9.59091V15H15.697V9.19697C15.697 7.70202 15.3434 6.56818 14.6364 5.79545C13.9293 5.02273 12.995 4.63636 11.8333 4.63636C10.5303 4.63636 9.51515 5.19697 8.78788 6.31818V6.34849H8.77273L8.78788 6.31818V4.87879H5.42424C5.44444 5.20202 5.45455 6.20706 5.45455 7.89394C5.45455 9.5808 5.44444 11.9495 5.42424 15Z"
          fill="currentColor"
        />
      </svg>
    </span>
